...
- OOF MAE 公式: 2.91053076133046；最优残差学习器: 3.0260408695042997；综合推荐: `formula_only`（MAE=2.91053076133046）
- MAE 低于公式的残差学习器: []

### flexural
- 最优残差学习器（三者中 OOF MAE 最低）: `hgb`
- OOF MAE 公式: 0.45691845640602086；最优残差学习器: 0.5626225203476672；综合推荐: `formula_only`（MAE=0.45691845640602086）
- MAE 低于公式的残差学习器: []
...
- 最优模型后整体偏差 mean(y_true − final_pred): 1.0183360602465936
- **是否缩小相对公式的 |偏差|**: True
...
- 最优模型后整体偏差 mean(y_true − final_pred): 0.1579604035245396
- **是否缩小相对公式的 |偏差|**: True
